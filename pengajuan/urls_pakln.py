...
urlpatterns = [
    ...
    path("nd/preview/", views.preview_nd, name="preview_nd"),
    path("nd/simpan/", views.simpan_nd, name="simpan_nd"),
    path("nd/riwayat/", views.riwayat_nd, name="riwayat_nd"),
    path("nd/pengaturan/", views.pengaturan_nd, name="pengaturan_nd"),
